    ...
    _m_ppiLayer(nullptr),_m_trackLayer(nullptr), m_mapLayersVisible(true)
{
    ...
    setCanvasColor(QColor("#e5e7eb")); // Light neutral grey background
...
void CMapCanvas::_loadVectorMaps() {
    ...
    QString directoryPath = "../maps/ShpRepository/India/";
    QDir dir(directoryPath);
...
void CMapCanvas::setMapLayersVisible(bool visible)
{
    ...
    if (visible) {
        ...
        setCanvasColor(QColor("#111827")); // Dark grey background for PPI-only mode
    }
