...
void CRecordingWidget::createRecordingSection()
{
    ...
    // Status labels
    m_recordStatusLabel = new QLabel("Status: <span style='color: #9a9a9a;'>Idle</span>");
...
void CRecordingWidget::createReplaySection()
{
    ...
    // Status labels
    m_replayStatusLabel = new QLabel("Status: <span style='color: #9a9a9a;'>Idle</span>");
...
void CRecordingWidget::startRecording()
{
    ...
    *m_recordingStream << QDateTime::currentDateTime();
    ...
    m_recordStatusLabel->setText("Status: <span style='color: #6a6a6a;'>● Recording</span>");
...
void CRecordingWidget::stopRecording()
{
    ...
    m_recordStatusLabel->setText("Status: <span style='color: #8a8a8a;'>Saved</span>");
...
void CRecordingWidget::pauseRecording()
{
    ...
    if (m_isRecordingPaused) {
        ...
        m_recordStatusLabel->setText("Status: <span style='color: #8a8a8a;'>⏸ Paused</span>");
...
void CRecordingWidget::startReplay()
{
    if (m_isReplayPaused) {
        ...
        m_replayStatusLabel->setText("Status: <span style='color: #8a8a8a;'>▶ Playing</span>");
...
void CRecordingWidget::stopReplay()
{
    ...
    m_replayStatusLabel->setText("Status: <span style='color: #9a9a9a;'>Idle</span>");
...
void CRecordingWidget::pauseReplay()
{
    ...
    if (m_isReplayPaused) {
        ...
        m_replayStatusLabel->setText("Status: <span style='color: #8a8a8a;'>⏸ Paused</span>");
