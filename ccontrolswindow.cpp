...
void CControlsWindow::setupUI()
{
    ...
    statusBar()->setStyleSheet(
        "QStatusBar {"
        "   background: qlineargradient(x1:0, y1:0, x2:1, y2:0, stop:0 #FFF8DC, stop:1 #F5DEB3);"
        "   color: #000000;"
...
void CControlsWindow::applyLightTheme()
{
    ...
    QString lightTheme = 
        ...
        "}"
        "QTabBar::tab {"
        "   background: qlineargradient(x1:0, y1:0, x2:0, y2:1, stop:0 #FAEBD7, stop:1 #F5DEB3);"
        "   color: #000000;"
        "   border: 2px solid #F5DEB3;"
        "   border-bottom: none;"
        ...
        "   background: qlineargradient(x1:0, y1:0, x2:0, y2:1, stop:0 #FFE4B5, stop:1 #FFDAB9);"
        "   color: #000000;"
        "   border-color: #DEB887;"
        "}"
        ...
        "}"
        "QPushButton:hover {"
        "   background: qlineargradient(x1:0, y1:0, x2:0, y2:1, stop:0 #FFDAB9, stop:1 #DEB887);"
        "}"
        "QPushButton:pressed {"
        "   background: qlineargradient(x1:0, y1:0, x2:0, y2:1, stop:0 #DEB887, stop:1 #D2B48C);"
        "}"
        "QPushButton:checked {"
        "   background: qlineargradient(x1:0, y1:0, x2:0, y2:1, stop:0 #F0E68C, stop:1 #BDB76B);"
        ...
        "   padding: 3px 10px;"
        "   background: qlineargradient(x1:0, y1:0, x2:1, y2:0, stop:0 #FFE4B5, stop:1 #FFDAB9);"
        "   border-radius: 3px;"
        "   color: #000000;"
        "   font-weight: 600;"
        "   font-size: 11px;"
        ...
        "   background: qlineargradient(x1:0, y1:0, x2:1, y2:0, stop:0 #FFDAB9, stop:1 #DEB887);"
        "}";
