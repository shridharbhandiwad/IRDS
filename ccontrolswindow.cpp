...
void CControlsWindow::setupUI()
{
    ...
    statusBar()->setStyleSheet(
        "QStatusBar {"
        "   background: qlineargradient(x1:0, y1:0, x2:1, y2:0, stop:0 #FFFAF0, stop:1 #FFF8E7);"
        "   color: #000000;"
...
void CControlsWindow::applyLightTheme()
{
    ...
    QString lightTheme = 
        ...
        "}"
        "QTabBar::tab {"
        "   background: qlineargradient(x1:0, y1:0, x2:0, y2:1, stop:0 #FFEFD5, stop:1 #FFE4B5);"
        "   color: #000000;"
        "   border: 2px solid #DEB887;"
        "   border-bottom: none;"
        ...
        "   background: qlineargradient(x1:0, y1:0, x2:0, y2:1, stop:0 #FFD700, stop:1 #FFE4B5);"
        "   color: #000000;"
        "}"
        "QPushButton {"
        "   background: qlineargradient(x1:0, y1:0, x2:0, y2:1, stop:0 #FFE4B5, stop:1 #FFDEAD);"
        ...
        "   background: qlineargradient(x1:0, y1:0, x2:1, y2:0, stop:0 #FFD700, stop:1 #FFE4B5);"
        "}";
