...
void CControlsWindow::setupUI()
{
    ...
    statusBar()->setStyleSheet(
        "QStatusBar {"
        "   background: qlineargradient(x1:0, y1:0, x2:1, y2:0, stop:0 #3a3a3a, stop:1 #2d2d2d);"
        "   color: #d0d0d0;"
...
void CControlsWindow::applyLightTheme()
{
    ...
    QString greyTheme = 
        ...
        "   padding: 3px 10px;"
        "   background: qlineargradient(x1:0, y1:0, x2:1, y2:0, stop:0 #606060, stop:1 #505050);"
        "   border-radius: 3px;"
        "   color: #ffffff;"
        "   font-weight: 600;"
        "   font-size: 11px;"
        ...
        "   background: qlineargradient(x1:0, y1:0, x2:1, y2:0, stop:0 #707070, stop:1 #606060);"
        "   border: 2px solid #808080;"
        "   width: 18px;"
        "   margin: -6px 0;"
        "   border-radius: 9px;"
